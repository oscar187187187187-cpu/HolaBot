...
def is_echo(user_text, ai_text):
    ...
    if not user_clean or not ai_clean:
        return False
    # Wenn die KI mehr als 50% der gleichen Wörter in gleicher Reihenfolge nutzt
...
def get_integrated_response(user_text, words_list, difficulty_level, is_start=False, start_word=None, used_questions=None):
    ...
    STARKE Anti-Echo-Regel mit Beispielen und Fragen-Memory!
    """
    ...
    # Kontext für die KI (nur die letzten 3 Nachrichten für max. Geschwindigkeit + Fragen-Memory)
    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=messages,
            temperature=0.4,  # Höher für kreativere, unterschiedliche Fragen
            max_tokens=200,
        ...
        # Anti-Echo Check: Wenn die KI echoed, Fallback-Frage nutzen
